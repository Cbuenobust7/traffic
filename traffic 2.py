...
def load_data(data_dir):
    ...
    for directory in directories:
        ...
        # get dir_path of a specific sign and file_names of images
        dir_path = os.sep.join([data_dir, directory])
        img_files = os.listdir(dir_path)

        for img_file in img_files:
            # get path of image
            img_path = os.sep.join([data_dir, directory, img_file])
            # read image and resize to asked dimension
